...
export class HomeService {
  ...
  getProductsHighlight() {
    return this.http.get<ProductInterface>(`${this._urlBackendApi}/product/highlight`);
  }

  getIngredientes(idCategory: number) {
    return this.http.get<AdditionalInterface>(`${this._urlBackendApi}/additional/category/${idCategory}`);
  }
}
